	...
	<div class="row">
    	<div class="col-sm-12">
        	<div class="header bg-white">            		
					...
					<span>Hello 
							<?php echo $s['username']; echo " !";?>
												</span>
							<span id="blinker"><span style="font-size:15px; color:blue";>
							<?php
                            $Today=date('y:m:d');
    ...
    <div class="row">
    	<div class="col-sm-12">
        	<div class="footer bg-white">
            	<div class="copyright">
                	<p align="center" style="padding-top:10px;">Farhan Bashir &copy; &nbsp;&nbsp;&nbsp;<span style="color:#CC0033">info.pankajku75@gmail.com</span></p>
                </div>
            </div>
        </div>
    </div>
